...
# dict containing suits and their count
from collections import Counter
hands = (line.split() for line in open('poker.txt', 'r'))
...
print("Answer: ", sum(hand_rank(hand[:5]) > hand_rank(hand[5:]) for hand in hands))
